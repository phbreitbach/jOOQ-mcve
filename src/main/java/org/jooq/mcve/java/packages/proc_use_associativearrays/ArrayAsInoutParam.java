...
public class ArrayAsInoutParam extends AbstractRoutine<java.lang.Void> {
    ...
    /**
     * The parameter <code>DEVSB.PROC_USE_ASSOCIATIVEARRAYS.ARRAY_AS_INOUT_PARAM.P_FEHLERTEXT</code>.
     */
    public static final Parameter<String> P_FEHLERTEXT = Internal.createParameter("P_FEHLERTEXT", SQLDataType.VARCHAR, false, false);

    /**
     * The parameter <code>DEVSB.PROC_USE_ASSOCIATIVEARRAYS.ARRAY_AS_INOUT_PARAM.P_AUFRUFERGEBNIS</code>.
     */
    ...
    /**
     * The parameter <code>DEVSB.PROC_USE_ASSOCIATIVEARRAYS.ARRAY_AS_INOUT_PARAM.P_LISTE</code>.
     */
    ...
    public ArrayAsInoutParam() {
        super("ARRAY_AS_INOUT_PARAM", Devsb.DEVSB, ProcUseAssociativearrays.PROC_USE_ASSOCIATIVEARRAYS);
