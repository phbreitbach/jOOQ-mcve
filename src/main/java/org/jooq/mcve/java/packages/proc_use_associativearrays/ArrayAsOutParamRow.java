...
public class ArrayAsOutParamRow extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>DEVSB.PROC_USE_ASSOCIATIVEARRAYS.ARRAY_AS_OUT_PARAM_ROW.P_FEHLERTEXT</code>.
     */
    public static final Parameter<String> P_FEHLERTEXT = Internal.createParameter("P_FEHLERTEXT", SQLDataType.VARCHAR, false, false);

    /**
     * The parameter <code>DEVSB.PROC_USE_ASSOCIATIVEARRAYS.ARRAY_AS_OUT_PARAM_ROW.P_AUFRUFERGEBNIS</code>.
     */
    ...
    /**
     * The parameter <code>DEVSB.PROC_USE_ASSOCIATIVEARRAYS.ARRAY_AS_OUT_PARAM_ROW.P_LISTE</code>.
     */
     ...
     */
    public ArrayAsOutParamRow() {
        super("ARRAY_AS_OUT_PARAM_ROW", Devsb.DEVSB, ProcUseAssociativearrays.PROC_USE_ASSOCIATIVEARRAYS);
