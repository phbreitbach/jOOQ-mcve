...
public class ArrayAsOutParamRow extends AbstractRoutine<java.lang.Void> {
    ...
    /**
     * The parameter
     * <code>MCVE.PROC_USE_ASSOCIATIVEARRAYS.ARRAY_AS_OUT_PARAM_ROW.P_FEHLERTEXT</code>.
     */
    public static final Parameter<String> P_FEHLERTEXT = Internal.createParameter("P_FEHLERTEXT", SQLDataType.VARCHAR, false, false);

    /**
     * The parameter
     * <code>MCVE.PROC_USE_ASSOCIATIVEARRAYS.ARRAY_AS_OUT_PARAM_ROW.P_AUFRUFERGEBNIS</code>.
     */
    ...
    /**
     * The parameter
     * <code>MCVE.PROC_USE_ASSOCIATIVEARRAYS.ARRAY_AS_OUT_PARAM_ROW.P_LISTE</code>.
     */
    ...
    public ArrayAsOutParamRow() {
        super("ARRAY_AS_OUT_PARAM_ROW", Mcve.MCVE, ProcUseAssociativearrays.PROC_USE_ASSOCIATIVEARRAYS);
