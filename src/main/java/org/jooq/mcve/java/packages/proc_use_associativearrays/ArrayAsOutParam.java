...
public class ArrayAsOutParam extends AbstractRoutine<java.lang.Void> {
    ...
    /**
     * The parameter
     * <code>MCVE.PROC_USE_ASSOCIATIVEARRAYS.ARRAY_AS_OUT_PARAM.P_FEHLERTEXT</code>.
     */
    public static final Parameter<String> P_FEHLERTEXT = Internal.createParameter("P_FEHLERTEXT", SQLDataType.VARCHAR, false, false);

    /**
     * The parameter
     * <code>MCVE.PROC_USE_ASSOCIATIVEARRAYS.ARRAY_AS_OUT_PARAM.P_AUFRUFERGEBNIS</code>.
     */
    ...
    /**
     * The parameter
     * <code>MCVE.PROC_USE_ASSOCIATIVEARRAYS.ARRAY_AS_OUT_PARAM.P_LISTE</code>.
     */
    ...
    public ArrayAsOutParam() {
        super("ARRAY_AS_OUT_PARAM", Mcve.MCVE, ProcUseAssociativearrays.PROC_USE_ASSOCIATIVEARRAYS);
