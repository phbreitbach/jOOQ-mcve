...
public class ArrayAsOutParam extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>DEVSB.PROC_USE_ASSOCIATIVEARRAYS.ARRAY_AS_OUT_PARAM.P_FEHLERTEXT</code>.
     */
    public static final Parameter<String> P_FEHLERTEXT = Internal.createParameter("P_FEHLERTEXT", SQLDataType.VARCHAR, false, false);

    /**
     * The parameter <code>DEVSB.PROC_USE_ASSOCIATIVEARRAYS.ARRAY_AS_OUT_PARAM.P_AUFRUFERGEBNIS</code>.
     */
    ...
    /**
     * The parameter <code>DEVSB.PROC_USE_ASSOCIATIVEARRAYS.ARRAY_AS_OUT_PARAM.P_LISTE</code>.
     */
     ...
     */
    public ArrayAsOutParam() {
        super("ARRAY_AS_OUT_PARAM", Devsb.DEVSB, ProcUseAssociativearrays.PROC_USE_ASSOCIATIVEARRAYS);

        addInParameter(P_FEHLERTEXT);
        addOutParameter(P_AUFRUFERGEBNIS);
        addOutParameter(P_LISTE);
    }
